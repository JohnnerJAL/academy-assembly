...
section .bss
    ...
    result resb 255         ; Reserva espacio para almacenar el resultado de la multiplicación
...
_start:
    ...
    mul bl               ; Multiplicar el primer número por el segundo
    ...
    mov ebx, 1
    mov ecx, result_msg
    mov edx, 39   ; Longitud del mensaje incluyendo el carácter nulo
    int 0x80
    ...
    mov edx, 2      ; Cargar la cantidad de bytes a escribir (2 bytes para un número de dos dígitos)
    int 0x80
